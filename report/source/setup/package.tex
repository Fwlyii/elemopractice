...
\def\CJKrmdefault{gbsn}
\def\CJKsfdefault{gbsn}
\def\CJKttdefault{gbsn}
\usepackage[UTF8,fontset=none]{ctex}        % 中文由模板现有的 CJKutf8 字体配置负责
\usepackage{CJKpunct}
...
\usepackage{xcolor}
\newcommand{\newreq}[1]{{\color{red}#1}}
\newcommand{\changedfigure}[1]{%
  \par\vspace{0.4em}\noindent
  {\color{red}\fbox{\parbox{0.92\linewidth}{\textbf{审阅标记：本图需更新。}#1}}}%
}
%支持代码环境
\usepackage{listings}
\lstset{numbers=left,
