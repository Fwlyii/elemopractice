...
\newcommand{\song}{\CJKfamily{gbsn}}    % 宋体（TeX Live 自带字体）
\newcommand{\fs}{\CJKfamily{gbsn}}      % 仿宋体回退到宋体
\newcommand{\kai}{\CJKfamily{gkai}}     % 楷体（TeX Live 自带字体）
\newcommand{\hei}{\CJKfamily{gbsn}}     % 黑体回退到宋体
\newcommand{\li}{\CJKfamily{gbsn}}      % 隶书回退到宋体
...
%%%%%%%%%% Theorem Environment %%%%%%%%%%%%%%%%%
\theoremstyle{plain}
\theorembodyfont{\rmfamily\song}
\theoremheaderfont{\rmfamily\hei}
